...
// build/dev/javascript/lustre_carousel/lustre_carousel.mjs
...
function view(_) {
  return div(
    toList([
      class$("h-[500px] bg-cover grid grid-cols-12 py-24"),
      style(toList([["background-image", "url(images/pbx.jpg)"]])),
      class$("bg-white p-10")
    ]),
    toList([
      h1(
        toList([
          ...
          style(
            toList([["text-shadow", "0 1px 2px rgba(0,0,0,.6)"]])
          )
        ]),
